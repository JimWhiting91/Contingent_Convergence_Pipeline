#---------------------------
# SLIM MASTER SCRIPT - NO_EXPANSION. This variant of the script modifies population sizes so total N is simulations is limited to POP_N
...
cp $MASTER/scripts/3.5_Chunk_NO_EXPANSION.txt 3.5_Chunk_Slim_mod_SIM_SECOND_HALF_${MOAB_JOBARRAYINDEX}
...
finalsize_array=(0.01 0.01 0.1 0.1 0.5 0.5 0.75 0.75 0.01 0.01 0.1 0.1 0.5 0.5 0.75 0.75)
